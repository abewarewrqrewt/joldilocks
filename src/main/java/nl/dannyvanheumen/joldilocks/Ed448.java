...
//     Y(P): 298819210078481492676017930443930673437544040154080242095928241372331506189835876003536878655418784733982303233503462500531545062832660
    ...
    @CheckReturnValue
    public static boolean contains(final Point p) {
    ...
    public static byte[] sign(final byte[] symmetricKey, final byte[] context, final byte[] message) {
        ...
        // FIXME This is an actual issue! Should we always add one zero byte, or is there a possibility that we need to add more on occasion?
